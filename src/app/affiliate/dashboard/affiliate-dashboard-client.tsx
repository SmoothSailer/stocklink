...
import type { Affiliate, Referral, ReferralStatus } from "@/types/database";
...
export default function AffiliateDashboardClient({ affiliate, referrals }: AffiliateDashboardClientProps) {
